 ...
 placeholder='Enter Your Email'
  name='email'
   value={formData.email}
    ...
    className='w-full px-4 py-3 border-b border-solid border-[#0066ff61] focus-outline-none focus:border-b-primaryColor text-[16px] leading-7 text-headingColor placeholder:texttextColor rounded-md cursor-pointer '
   required
   />
</div>
<div className='mb-5'>
